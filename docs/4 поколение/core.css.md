...
`.layout[style*="--bg:#ffffff"]` - При выборе настроек `Виджет -> Цвет фона виджета`

`.layout[style*="--layout-wide-bg:true"]` - При выборе настроек `Виджет -> Растянуть фон`

`.layout[style*="--layout-edge:true"]` - При выборе настроек `Виджет -> Убрать отступы по краям`

`.layout[style*="--hide-mobile:true"]` - При выборе настроек `Виджет -> Скрыть на телефоне`

`.layout[style*="--hide-desktop:true"]` - При выборе настроек `Виджет -> Скрыть на десктопе`

`.layout[style*="--bg:"][style*="--layout-wide-bg:true"]` - Мы можем комбинировать настройки. При выборе настроек `Виджет -> Цвет фона виджета` и `Виджет -> Растянуть фон`
