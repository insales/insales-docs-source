...
- `Баннер` | Поля: Название (Текст), Описание (HTML), Изображение (Файл), Ссылка - `link` (тип поля в редакторе - Текст), Текст ссылки (Текст)
- `system-banner-block-2` | Поля: Название - `name` (тип поля в редакторе - Текст), Описание (HTML), Изображение - `image` (тип поля в редакторе - Файл), Ссылка (Универсальная ссылка), Текст ссылки (Текст)
- `system-banner-block-3` | Поля: Название - `name` (тип поля в редакторе - Текст), Описание (HTML), Карта (Текст)
- `system-banner-image-text` | Поля: Изображение - `image` (тип поля в редакторе - Файл), Положение изображения (Выпадающий список), Ссылка на изображение (Текст), Текст (HTML)
- `system-banner-mansonry` | Поля: Название - `name` (тип поля в редакторе - Текст), Контент (HTML), Ссылка - `link` (тип поля в редакторе - Текст), Изображение (Файл), Соотношение сторон (Высота / Ширина) (Выпадающий список)
- `system-banner-video` <a name="blocks_example"></a> | Поля: Ссылка - `link` (тип поля в редакторе - Текст), Заставка (Файл)
- `system-banner-video-2` | Поля: Ссылка (Универсальная ссылка), Заставка (Файл)
- `system-benefit` | Поля: Описание (Текст), Изображение - `image` (тип поля в редакторе - Файл)
- `system-benefit-2` | Поля: Заголовок (Текст), Описание (HTML), Изображение - `image` (тип поля в редакторе - Файл)
- `system-collection` | Поля: Категория (Категория)
- `system-collection-2` | Поля: Название вкладки (Текст), Категория (Категория)
- `system-collection-3` | Поля: Категория (Категория), Заголовок (Текст), Изображение - `image` (тип поля в редакторе - Файл)
- `system-collection-4` | Поля: Категория (Категория), Изображение - `image` (тип поля в редакторе - Файл)
...
- `system-form-constructor` | Поля: Название - `name` (тип поля в редакторе - Текст), Тип поля (Выпадающий список), Значения (через запятую) (Только для групп чекбоксов, радио и списка) (Текст), Обязательное поле (Чекбокс)

- `system-form-constructor-2` | Поля: Тип поля (Выпадающий список), Ширина поля (Выпадающий список), Название - `name` (тип поля в редакторе - Текст), Подсказка (только для текст и текстовая область) (Текст), Значения (через запятую) (Только для групп чекбоксов, радио и списка) (Текст), Обязательное поле (Чекбокс)

- `system-form-constructor-3` | Поля: Тип поля (Выпадающий список), Название - `name` (тип поля в редакторе - Текст), Обязательное поле (Чекбокс)

- `system-image` | Поля: Название - `name` (тип поля в редакторе - Текст), Изображение (Файл)

- `system-image-and-content` | Поля: Вертикальная позиция изображения (Выпадающий список), Скрыть изображение? (Чекбокс), Текст (HTML), Горизонтальная позиция изображения (Выпадающий список), Изображение - `image` (тип поля в редакторе - Файл)

- `system-image-link-text` | Поля: Изображение - `image` (тип поля в редакторе - Файл), Кнопка (Текст), Текст кнопки (Текст)
- `system-image_text` | Поля: Текст (HTML), Изображение (Файл)
- `system-image-text-button-icon` | Поля: Название - `name` (тип поля в редакторе - Текст), Описание (HTML), Изображение - `image` (тип поля в редакторе - Файл), Ссылка - `link` (тип поля в редакторе - Текст), Текст кнопки (Текст), Иконка (Файл)
- `system-messenger` | Поля: Заголовок (Текст), Иконка (Выпадающий список), Ссылка - `link` (тип поля в редакторе - Текст), Цвет (Текст)
- `system-messengers` | Поля: Заголовок (Текст), Иконка (Выпадающий список), Ссылка - `link` (тип поля в редакторе - Текст), Цвет (Цвет)
- `system-payments` | Поля: Ссылка (Текст)
- `system-payments-prime` | Поля: Иконка (Файл), Название (title) (Текст)
- `system-payments-social` | Поля: Название - `name` (тип поля в редакторе - Текст), Иконка (Файл), Тип (Выпадающий список), Ссылка - `link` (тип поля в редакторе - Текст)
- `system-personal` | Поля: Изображение - `image` (тип поля в редакторе - Файл), Описание (HTML), Подзаголовок (Текст), Заголовок (Текст)
- `system-promo-slide` | Поля: Описание (Текст), Изображение - `image` (тип поля в редакторе - Файл), Ссылка (Текст)
- `system-promo-slide-2` | Поля: Описание (Текст), Изображение - `image` (тип поля в редакторе - Файл), Ссылка (Универсальная ссылка)
- `system-promo-slider-2` | Поля: Заголовок (Текст), Описание (Текст), Ссылка - `link` (тип поля в редакторе - Текст), Изображение (Файл), Надпись на кнопке (Текст)
- `system-promo-slider-3` | Поля: Надпись на кнопке (Текст), Изображение для мобильных устройств (Файл), Изображение - `image` (тип поля в редакторе - Файл), Ссылка - `link` (тип поля в редакторе - Текст), Описание (Текст), Заголовок (Текст)
- `system-promo-slider-4` | Поля: Описание (Текст), Заголовок (Текст), Ссылка - `link` (тип поля в редакторе - Текст), Изображение (Файл)
...
- `system-promo-slider-6` | Поля: Изображение - `image` (тип поля в редакторе - Файл), Изображение для мобильных устройств (Файл),Заголовок (Текст), Описание (Текст), Ссылка (Универсальная ссылка), Надпись на кнопке (Текст)
- `system-promo-slider-7` | Поля: Описание (Текст), Заголовок (Текст), Ссылка (Универсальная ссылка), Изображение (Файл)
- `system-promo-slider-8` | Поля: Изображение - `image` (тип поля в редакторе - Файл), Изображение для мобильных устройств (Файл),Заголовок (Текст), Описание (Текст), Ссылка (Универсальная ссылка)
- `system-review` | Поля: Скрыть изображение? (Чекбокс), Текст (HTML), Имя (Текст), Позиция изображения (Выпадающий список), Изображение - `image` (тип поля в редакторе - Файл)
- `system-review-2` | Поля: Скрыть изображение? (Чекбокс), Имя (Текст), Текст (HTML), Изображение (Файл)
- `system-review-4` | Поля: Заголовок (Текст), Подзаголовок (Текст), Текст (HTML), Изображение - `image` (тип поля в редакторе - Файл), Скрыть изображение? (Чекбокс)
- `system-review-shop` | Поля: Имя (Текст), Текст (HTML), Рейтинг (Число из диапазона со слайдером), Дата (Текст), Изображение - `image` (тип поля в редакторе - Файл), Скрыть изображение? (Чекбокс)
- `system-review-social` | Поля: Ссылка - `link` (тип поля в редакторе - Текст)
- `system-social-2` | Поля: Иконка (Выпадающий список), Ссылка - `link` (тип поля в редакторе - Текст)
- `system-special_products` | Поля: Заголовок (Текст), Категория (Категория)
- `system-text-column` | Поля: Контент (HTML)
- `system-text-hex` | Поля: Название - `name` (тип поля в редакторе - Текст), Цвет (hex формат) (Текст)
- `system-text-hex-2` | Поля: Название - `name` (тип поля в редакторе - Текст), Цвет (Цвет)
