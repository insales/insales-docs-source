...
Настройки виджета в json формате которые отображаются в редакторе, дефолтные значения прописываются в файле <a href="/Generation%204/Виджеты/Структура/settings_data/">settings_data.json</a>
