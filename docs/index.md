...
<b>Панель администратора</b> - с панели администратора можно загрузить шаблоны и виджеты и редактировать код.<br>
...
<b>Верхняя панель редактора</b> - область редактора, где располагаются общие настройки шаблона.
