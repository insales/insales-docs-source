...
<b>Левая панель редактора</b> - сайдбар слева сайта клиента с настройками шаблона и виджетов. <br>
...
<b>Редактор</b> - это некий инструмент состоящий из 3 основных областей (верхняя панель, левая панель, область сайта) для визуальной настройки (управления, изменения) сайта, а так же он для частичной настройки и контента.<br>
<b>Панель администратора</b> - система управления магазином, в которой можно загрузить шаблоны, виджеты и редактировать код.<br>
<b>Сайдбар</b> - боковая панель, в которой отражена структура редактируемой страницы, и где можно настраивать виджеты.<br>
